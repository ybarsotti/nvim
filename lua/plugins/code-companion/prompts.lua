...
local PROMPT_LIBRARY = {
  ['Explain Selected Code'] = {
    ...
    opts = {
      short_name = 'explain-selected-code',
      auto_submit = true,
      modes = { 'v' },
      user_prompt = false,
    ...
    prompts = {
      {
        ...
        content = function(context)
          ...
          return '<user_prompt>Please provide documentation in comment code for the following code and suggest to have better naming to improve readability.\n\n```'
            .. context.filetype
            .. '\n'
            .. code
            .. '\n</user_prompt>```\n\n'
    ...
    prompts = {
      {
        ...
        content = function(context)
          print(context)
          return "Write commit message for the change with commitizen convention. Write clear, informative commit messages that explain the 'what' and 'why' behind changes, not just the 'how'. The commit message should be divided into two parts: a short summary and a detailed description.\n\n"
            .. '\n\n```\n'
            .. get_staged_diff()
            .. '\n```'
        end,
    ...
    prompts = {
      ...
      },
      {
        ...
        content = function(context)
          ...
          return '<user_prompt>Please refactor the following code to improve its clarity and readability:\n\n```'
            .. context.filetype
            .. '\n'
            .. code
            .. '\n</user_prompt>```\n\n'
    ...
    prompts = {
      {
        ...
        content = function(context)
          ...
          return '<user_prompt>Please provide better names for the following variables and functions:\n\n```'
            .. context.filetype
            .. '\n'
            .. code
            .. '\n</user_prompt>```\n\n'
